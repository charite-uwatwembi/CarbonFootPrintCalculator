...
country = st.selectbox("Select", ["Rwanda"])
...
if st.button("Calculate CO2 Emissions"):
    ...
    with col4:
        ...
        st.warning("In 2021, CO2 emissions per capita for Rwanda was 0.09 tons of CO2 per capita. Though Rwanda CO2 emissions per capita fluctuated substantially in recent years, it tended to increase through 1972 - 2021 period ending at 0.09 tons of CO2 per capita in 2021.")
